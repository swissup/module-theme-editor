...
class DescriptionDestinationBreeze implements \Magento\Framework\Data\OptionSourceInterface
{
    /**
     * Options getter
     *
    ...
    public function toOptionArray()
    {
        return [
            ...
            // ['value' => 'content.before', 'label' => __('Before products list into main column')], breaks layered navigation on mobile devices
